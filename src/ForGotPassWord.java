...
public class ForGotPassWord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Chúng tôi sẽ gửi bạn 1 email chứa mật khẩu của bạn, nếu không nhận được email");

        jLabel6.setForeground(new java.awt.Color(102, 102, 102));
        jLabel6.setText("Bấm vào nút gửi lại email sau 30s (Check kỹ mục spam)");
